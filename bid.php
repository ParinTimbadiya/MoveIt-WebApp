      ...
      <div class="col-lg-8" style="    margin-left: 10%;">
        <div class="card">
          <div class="card-title">
            <h1>Enter Bid On Job</h1>
          </div>
          <div class="card-body">
            <div class="input-states">
              <form action="./php_action/submit-bid.php?JobId=<?= $JobId ?>" method="post">
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-3 control-label">Enter Bid Price</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="Enter Bid Price" name="Amount" required="" />
                    </div>
                  </div>
                </div>
                <div class="form-group">
                  <div class="row">
                    <label class="col-sm-3 control-label">Enter Description</label>
                    <div class="col-sm-9">
